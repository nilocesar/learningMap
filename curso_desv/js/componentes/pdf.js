define(['jquery', 'scorm'], function ($) {
    ...
    var pdf = function () {
        ...
        $public.createPdf = function createPdf( id_, w_, h_, _scrolling, _close ) {
            var _scroll = "no"
            ...
            $("#v5_lightbox").remove();
            $('body').prepend('<div id="v5_lightbox"><div class="bcg"></div><div class="containerModal"><iframe class="modalIframe" width=' + w + ' height=' + h + ' src="base/pdf/viewer.html" frameborder="0" scrolling=' + _scroll + ' allowfullscreen></iframe></div></div>');
            ...
            ///Loader Iframe
            $('.modalIframe')[0].contentWindow.DEFAULT_URL = "../../" + id;
        ...
        $public.removePdf = function removePdf() {
